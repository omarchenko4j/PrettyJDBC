...
/**
 * This internal interface provides methods for setting parameter values by name in a specific {@link com.github.marchenkoprojects.prettyjdbc.query.NamedParameterQuery}.
 *
...
interface NamedParameterQuerySetter<Q> {
    ...
    /**
     * Sets the designated parameter by name to the given Java {@link java.math.BigDecimal} value.
     *
     * @param paramName the name of the parameter
     * @param value the parameter value
     * @return instance of this query
    ...
    /**
     * Sets the designated parameter by name to the given Java {@link java.sql.Date} value.
     *
     * @param paramName the name of the parameter
     * @param value the parameter value
     * @return instance of this query
    ...
    /**
     * Sets the designated parameter by name to the given Java {@link java.time.LocalDate} value as {@link java.sql.Date}.
     *
     * @param paramName the name of the parameter
     * @param value the parameter value
     * @return instance of this query
    ...
    /**
     * Sets the designated parameter by name to the given Java {@link java.sql.Time} value.
     *
     * @param paramName the name of the parameter
     * @param value the parameter value
     * @return instance of this query
    ...
    /**
     * Sets the designated parameter by name to the given Java {@link java.time.LocalTime} value as {@link java.sql.Time}.
     *
     * @param paramName the name of the parameter
     * @param value the parameter value
     * @return instance of this query
    ...
    /**
     * Sets the designated parameter by name to the given Java {@link java.sql.Timestamp} value.
     *
     * @param paramName the name of the parameter
     * @param value the parameter value
     * @return instance of this query
    ...
    /**
     * Sets the designated parameter by name to the given Java {@link java.time.LocalDateTime} value as {@link java.sql.Timestamp}.
     *
     * @param paramName the name of the parameter
     * @param value the parameter value
     * @return instance of this query
